# Build the Cosmetic and Implant Dentistry Westport homepage — Phase 2 (Design)

You are Claude Code running inside Cursor. The scaffolded Astro project for **Cosmetic and Implant Dentistry Westport** is open as the workspace, and the design hand-off files are already in this workspace.
...
The slugified project name is `cosmetic-and-implant-dentistry-westport`.
