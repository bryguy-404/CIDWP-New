...
1. Follow `CLAUDE_KICKOFF.md` to scaffold the Astro project (TypeScript + Tailwind + MDX) into its `cosmetic-and-implant-dentistry-westport/` folder. Confirm the dev server boots cleanly, then stop it.
